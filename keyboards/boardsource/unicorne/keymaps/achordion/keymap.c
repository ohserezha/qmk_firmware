...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BAS] = LAYOUT_split_3x6_3(
      ...
      LCA(KC_SPC),  KC_Z,         KC_X,         KC_C,             KC_V,             KC_B,       KC_N,     KC_M,             KC_COMM,      KC_DOT,       KC_SLSH,         KC_RBRC, 
                                                LT(_NUM,KC_CAPS), LT(_NAV,KC_SPC),  MO(_BRC),   KC_ENT,   LT(_SYM,KC_BSPC), MO(_MED)
      ),
    [_NUM] = LAYOUT_split_3x6_3(
      KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_7,     KC_8,     KC_9,   KC_NO,  KC_NO, 
      KC_NO,    KC_LSFT,  KC_LCTL,  KC_LALT,  KC_LGUI,  KC_NO,    KC_NO,    KC_4,     KC_5,     KC_6,   KC_0,   KC_NO, 
    ...
    [_NAV] = LAYOUT_split_3x6_3(
      ...
      KC_TRNS, KC_LSFT,     KC_LCTL,    KC_LALT,        KC_LGUI,        KC_TRNS,  KC_TRNS,  KC_LEFT,        KC_DOWN,  KC_RGHT,        KC_TRNS,  KC_TRNS, 
    ...
    [_BRC] = LAYOUT_split_3x6_3(
      ...
      KC_NO,    KC_LSFT,  KC_LCTL,  KC_LALT,  KC_LGUI,  KC_NO,    KC_NO,    KC_LCBR, KC_RCBR, KC_PIPE, KC_BSLS, KC_NO, 
    ...
    [_SYM] = LAYOUT_split_3x6_3(
      ...
      KC_NO,    KC_EXLM, KC_AT,   KC_UNDS, KC_EQL,  KC_CIRC, KC_NO,   KC_RGUI,  KC_RALT,  KC_RCTL,  KC_RSFT,  KC_NO, 
